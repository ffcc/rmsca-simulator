...
public class Algorithms {
            ...
            while(currentImprovement < improvement && count < establishedRoutes.size()) {
                ...
                try {
                    ...
                    for (int j = 0; j < selectedRoutes.size() ; j++) {
                        Demand demand = new Demand(selectedRoutes.get(j).getFrom(), selectedRoutes.get(j).getTo(), 10);
    ...
    public static int selectRoute(double[] probabilities, ArrayList usedIndexes) {
        System.out.println("Probabilities: " + probabilities.length);
        ...
        System.out.println("probabilitiesSize: " + probabilities.length);
        System.out.println("indexOrderSize: " + indexOrder.length);
